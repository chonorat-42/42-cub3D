...
static void temp_img_loader(t_data *data)
{
	...
	data->tex_img.no_exit_img = mlx_xpm_file_to_image(data->mlx.mlx, "Textures/NO_EXIT.xpm", &size, &size);
	data->tex_img.so_exit_img = mlx_xpm_file_to_image(data->mlx.mlx, "Textures/SO_EXIT.xpm", &size, &size);
	data->tex_img.we_exit_img = mlx_xpm_file_to_image(data->mlx.mlx, "Textures/WE_EXIT.xpm", &size, &size);
	data->tex_img.ea_exit_img = mlx_xpm_file_to_image(data->mlx.mlx, "Textures/EA_EXIT.xpm", &size, &size);
}
